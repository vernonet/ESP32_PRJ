...
#define CFG_TUSB_DEBUG              1  //2, 1
#define TUD_TASK_TIMEOUT            10  //ms 10
...
#define CFG_TUD_AUDIO_FUNC_1_DESC_LEN                 TUD_AUDIO_MIC_ONE_CH_DESC_LEN_UAC2 //////////////////////////////////////////////////
...
#define CFG_TUD_AUDIO_EP_SZ_IN_                       (48) * CFG_TUD_AUDIO_FUNC_1_N_BYTES_PER_SAMPLE_TX * CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_TX      // 48 Samples (48 kHz) x 2 Bytes/Sample x CFG_TUD_AUDIO_N_CHANNELS_TX Channels - the Windows driver always needs an extra sample per channel of space more, otherwise it complains... found by trial and error
